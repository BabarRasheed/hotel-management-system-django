# Generated by Django 4.2 on 2024-01-04 08:53
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_number', models.PositiveIntegerField(blank=True, null=True, unique=True)),
                ('isAdmin', models.BooleanField(default=False, verbose_name='Is Admin')),
                ('isCustomer', models.BooleanField(default=False, verbose_name='Is Customer')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('booking_number', models.PositiveIntegerField(blank=True, null=True, unique=True)),
                ...
                ('reservation_date_out', models.DateTimeField()),
                ('party_size', models.PositiveIntegerField(blank=True, null=True)),
                ('special_requests', models.TextField(blank=True)),
                ('approval_status', models.BooleanField(default=False, verbose_name='approve')),
                ('approval_comment', models.CharField(default='Waiting for Approval', max_length=100)),
                ('checked', models.BooleanField(default=False, verbose_name='admin checked')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('price', djmoney.models.fields.MoneyField(decimal_places=2, default=Decimal('0.0'), default_currency='PHP', max_digits=12)),
                ('image', models.FileField(default='default.jpg', upload_to=hotel.models.rooms)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('image', models.FileField(blank=True, default='default.jpg', null=True, upload_to=hotel.models.user_directory_path)),
                ('full_name', models.CharField(blank=True, max_length=500, null=True)),
                ('phone', models.CharField(blank=True, max_length=100, null=True)),
                ('gender', models.CharField(choices=[('Female', 'Female'), ('Male', 'Male'), ('Other', 'Other')], default='Other', max_length=20)),
                ('country', models.CharField(blank=True, max_length=100, null=True)),
                ...
                ('address', models.CharField(blank=True, max_length=1000, null=True)),
                ('identity_type', models.CharField(blank=True, choices=[('National ID Number', 'National ID Number'), ("Driver's License", "Driver's License"), ('International Passport', 'International Passport')], max_length=200, null=True)),
                ('identity_image', models.FileField(blank=True, default='id.jpg', null=True, upload_to=hotel.models.user_directory_path)),
                ('facebook', models.URLField(blank=True, null=True)),
                ('twitter', models.URLField(blank=True, null=True)),
